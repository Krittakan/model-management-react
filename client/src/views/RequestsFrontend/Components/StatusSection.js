...
import { CardBody, FormGroup, Row, Col, Label, Button, Badge, ModalBody } from 'reactstrap';
                    ...
                    <Row>
                        <Col md="6">
                            ...
                            <FormGroup>
                                <Row>
                                    <Col md="6">
                                        <Label for="close">ยกเลิกคำร้อง</Label>
                                    </Col>
                                    <Col md="6">
                                        <Modal
                                            text="ยกเลิก"
                                            color="danger"
                                            header="ยืนยันการยกเลิกคำร้อง"
                                            body={() => {
                                                return (
                                                    <ModalBody>
