...
import { CardBody, FormGroup, Row, Col, Label, Button, Badge, ModalBody, Input } from 'reactstrap';
                    ...
                    <Row>
                        <Col md="6">
                            ...
                            <FormGroup>
                                <Row>
                                    <Col md="6">
                                        <Label for="close">ปรับสถานะคำร้อง</Label>
                                    </Col>
                                    <Col md="6">
                                        <Modal 
                                        text="สิ้นสุดคำร้อง"
                                        color="danger"
                                        header="ยืนยันการสิ้นสุดคำร้อง"
                                        body={() => {
                                            return (
                                                <div>
                                                    <Col>
